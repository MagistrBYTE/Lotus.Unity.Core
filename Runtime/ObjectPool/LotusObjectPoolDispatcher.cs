...
namespace Lotus
{
	namespace Core
	{
		...
		{
			#region ======================================= ДАННЫЕ ====================================================
			private static Dictionary<Int32, ILotusPoolManager> mPoolManagers;
			#endregion
			...
			/// </summary>
			public static Dictionary<Int32, ILotusPoolManager> PoolManagers
            {
				get
				{
					if (mPoolManagers == null)
					{
						mPoolManagers = new Dictionary<Int32, ILotusPoolManager>();
					}
