...
namespace Lotus
{
	namespace Core
	{
		...
		//!
		//! ## Использование
		//! 1. Воспользуйтесь элементами GUI (UI) и зарегистрирует их с помощью методов \ref Lotus.Common.XInputDispatcher как соответствующие кнопки (или джойстики).
		//! Также можно зарегистрировать джойстик как основные оси - тогда они будут эмулировать ввод мыши и клавиатуры (W, S, A, D)
		//! 2. Реализовать соответствующие интерфейсы \ref Lotus.Common.ILotusPointerDown.
