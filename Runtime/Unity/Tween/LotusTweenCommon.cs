...
namespace Lotus
{
	namespace Core
	{
		...
		//! ресурс \ref Lotus.Core.LotusTweenCurveStorage.
		...
		//! ресурс \ref Lotus.Core.LotusTweenSpriteStorage.
		...
		//!
		//! ## Использование
		//! 1. Путем создания переменных класса. В качестве типа переменных могут выступать типы: \ref Lotus.Core.CTweenInteger, 
		//! \ref Lotus.Core.CTweenSingle и другие.
		//! 2. В методе Update или LateUpdate должен выполнятся метод UpdateAnimation
		//! 3. В качестве отдельных компонент \ref Lotus.Core.LotusTweenSingle, \ref Lotus.Core.LotusTweenColor 
		//! 4. Для работы подсистемы анимации на сцене должен присутствовать центральный диспетчер анимации \ref Lotus.Core.LotusTweenDispatcher
		//! \ingroup CoreUnity
		/*@{*/
		//-------------------------------------------------------------------------------------------------------------
		/// <summary>
