...
namespace Lotus
{
	namespace Core
	{
		...
		//-------------------------------------------------------------------------------------------------------------
		[Serializable]
		[AddComponentMenu("Lotus/Core/Tween/Animation Sprite")]
		public class LotusTweenSpriteImage : MonoBehaviour
		{
			#region ======================================= ДАННЫЕ ====================================================
			[SerializeField]
			...
			public void UpdateAnimation()
			{
				...
				mUIImage.sprite = LotusTweenDispatcher.SpriteStorage.GetFrameSprite(mTweenSprite.GroupIndex,
